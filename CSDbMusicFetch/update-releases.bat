...
echo ========================================
echo.
echo(Reads the release IDs from the screenshots in '../public/PNG/Releases' (one ^<id^>.png per release), fetches each from CSDb, and rewrites the auto-generated release cards in '../public/index.html' (in place).
echo.
