//; =============================================================================
//; DATA SECTION - 20-Bar Frequency Lookup Tables
//; =============================================================================
...
.var file_freqTable20 = LoadBinary("FreqTable20.bin")

.align 256
FreqToBarLo: .fill 256, file_freqTable20.get(i + 0)
FreqToBarMid: .fill 256, file_freqTable20.get(i + 256)
FreqToBarHi: .fill 256, file_freqTable20.get(i + 512)
