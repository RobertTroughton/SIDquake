...
//; =============================================================================
//;                       FREQUENCY / RELEASE TABLES (80 BARS)
//; SID frequency-to-bar lookup (3 ranges) and ADSR release-rate tables used by
//; the 80-bar spectrum analyser. FreqTable80.bin is generated by FreqTableGen.py
//; (num_bars = 80). Identical in structure to freqtable.asm; only the bar count
//; differs so the freq->bar tables resolve to indices 0..79.
//; =============================================================================

.var file_freqTable = LoadBinary("FreqTable80.bin")
