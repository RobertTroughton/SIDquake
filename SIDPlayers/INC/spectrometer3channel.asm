...
.align 64                    // pow2 align: relocation-safe
...
.align 64                    // pow2 align: keeps the buffer in-page AND load-address-independent (relocatable)
.byte $00, $00
...
AnalyzeSingleVoice:
    //; TEST bit halts the oscillator: the voice is silent, skip it (see
    //; spectrometer.asm - avoids hard-restart phantom bars).
    ldy #4
    lda (zpRegPtr), y
    and #$08
    beq !testClear+
