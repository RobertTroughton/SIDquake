// C64 character ROM bitmaps. Each glyph is 8 bytes (8x8 pixels, MSB = leftmost
// column). The ROM holds two charsets selectable via $D018: UPPERCASE (uppercase
// + graphics, default on power-up) and LOWERCASE (mixed case + graphics).
// Indices follow the C64 screen-code mapping, not PETSCII; the second half of
// each table contains the reverse-video glyphs at codes 128-255.
const C64Fonts = {
    UPPERCASE: new Uint8Array([
    ...
    getFont(uppercase = true) {
        return uppercase ? this.UPPERCASE : this.LOWERCASE;
    }
};

// CommonJS export for Node-side tests; harmless in browser contexts.
if (typeof module !== 'undefined' && module.exports) {
    module.exports = C64Fonts;
}